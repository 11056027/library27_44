# Generated by Django 4.2.7 on 2024-01-05 03:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_set', models.ManyToManyField(blank=True, help_text='The users that belong to this group.', related_name='custom_groups', to='mysite.customuser', verbose_name='users')),
            ],
            bases=('auth.group',),
            managers=[
